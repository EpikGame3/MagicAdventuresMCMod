...
public class HolyBowItem extends Item {
	public HolyBowItem() {
		super(new Item.Properties().tab(MaModTabs.TAB_MAGIC_WEAPONS).durability(2513));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					HolyBowEntity entityarrow = HolyBowEntity.shoot(world, entity, world.getRandom(), 1.2f, 4, 5);

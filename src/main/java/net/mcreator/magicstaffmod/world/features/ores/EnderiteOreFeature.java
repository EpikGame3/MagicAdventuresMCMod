...
public class EnderiteOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("ma:enderite_ore", FEATURE, new OreConfiguration(List.of(OreConfiguration
				.target(new BlockStateMatchTest(Blocks.END_STONE.defaultBlockState()), MaModBlocks.ENDERITE_ORE.get().defaultBlockState())), 5));
		PLACED_FEATURE = PlacementUtils.register("ma:enderite_ore", CONFIGURED_FEATURE, List.of(CountPlacement.of(4), InSquarePlacement.spread(),

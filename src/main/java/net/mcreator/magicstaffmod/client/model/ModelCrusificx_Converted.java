package net.mcreator.magicstaffmod.client.model;
...
public class ModelCrusificx_Converted<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("ma", "model_crusificx_converted"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition group = partdefinition.addOrReplaceChild("group",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(-1.5F, -8.0F, -1.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-1.5F, 8.0F, -1.0F, 3.0F, 1.0F,
